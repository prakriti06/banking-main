...
<html lang="en">
<head>
   <title>DBR Bank - Earn More, Grow Together</title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><e>DBR Bank</e></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php"><i class="material-icons">Home</a>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>DBR Bank</h1>
      <p1> DBR Bank is a part of DBR foundation. It is one of the leading private banks and was among the first to receive approval from the Central bank of fund(CBF) to set up a private sector bank in 2021.
          Today, DBR Bank has a banking network of 608 branches and 12,08 ATM's in 900 cities/towns. DBR Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<div class="py-5">
 ...
 <p1>This website is the
      ...
      acknowledged within the website. Anyone may reproduce, distribute, adapt, translate the content on the website, without explicit permission, provided that the content is accompanied by an acknowledgement that DBR Bank website is the source and that it is clearly indicated if changes were made to the original content.</p1>
 </div>



<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>Prakriti Sharma</b> </br>Chairperson, DBR Foundation</p>
      </footer>
